...
)
{
    ...
    CHECK(reference_instructions ==
          (state25_successor == 16 ? UINT64_C(144) :
           ...
           (state25_successor >= 1 && state25_successor <= 31 &&
            state25_successor != 16 && state25_successor != 24 &&
            state25_successor != 27) ? UINT64_C(98) :
    ...
    CHECK(reference_cpu.procedure_calls - snap_calls ==
          (state25_successor == 16 ? UINT64_C(4) :
           ...
           (state25_successor >= 1 && state25_successor <= 31 &&
            state25_successor != 16 && state25_successor != 24 &&
            state25_successor != 27) ? UINT64_C(3) :
    ...
    printf(
        ...
        (state25_successor >= 1 && state25_successor <= 31 &&
         state25_successor != 16 && state25_successor != 24 &&
         state25_successor != 27) ? "-25-neutral" :
...
static void run_rom_differential(const char *rom_directory)
{
    ...
    for (int state25_successor = 1; state25_successor <= 31;
         ++state25_successor) {
        if (state25_successor != 16 && state25_successor != 24 &&
            state25_successor != 27) {

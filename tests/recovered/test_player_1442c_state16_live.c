...
static void run_case(const uint8_t *rom, size_t rom_size,
                     ...
                     uint32_t state0_194, uint32_t state1_194,
                     uint64_t expected_steps, uint64_t expected_calls)
{
    ...
    write_u32(&rm, f1, 0u);
    write_u32(&nm, f1, 0u);
    write_u32(&rm, f0 + UINT32_C(0x194), state0_194);
    write_u32(&nm, f0 + UINT32_C(0x194), state0_194);
    ...
    if (argc == 2) {
        ...
        if (rom != NULL && data != NULL) {
            run_case(rom, rom_size, data, data_size,
                     0u, 0u, 16u, TYPE5_INDEX, TYPE5_INDEX,
                     UINT64_C(100), UINT64_C(3));
            run_case(rom, rom_size, data, data_size,
                     1u, 0u, 16u, TYPE5_INDEX, TYPE5_INDEX,
                     UINT64_C(104), UINT64_C(3));
            run_case(rom, rom_size, data, data_size,
                     0u, 0u, 26u, TYPE5_INDEX, TYPE5_INDEX,
                     UINT64_C(98), UINT64_C(3));
            run_case(rom, rom_size, data, data_size,
                     0u, 0u, 27u, TYPE5_INDEX, TYPE5_INDEX,
                     UINT64_C(126), UINT64_C(4));
            run_case(rom, rom_size, data, data_size,
                     0u, 0u, 24u, TYPE5_INDEX, TYPE5_INDEX,
                     UINT64_C(105), UINT64_C(3));
            run_case(rom, rom_size, data, data_size,
                     0u, 25u, 24u, TYPE5_INDEX, TYPE5_INDEX,
                     UINT64_C(59), UINT64_C(2));
            run_case(rom, rom_size, data, data_size,
                     0u, 22u, 24u, TYPE5_INDEX, TYPE5_INDEX,
                     UINT64_C(60), UINT64_C(2));
            run_case(rom, rom_size, data, data_size,
                     0u, 0u, 25u, TYPE5_INDEX, 0u,
                     UINT64_C(144), UINT64_C(4));
            run_case(rom, rom_size, data, data_size,
                     0u, 0u, 25u, UINT32_C(0x0000006f), 0u,
                     UINT64_C(144), UINT64_C(4));
            run_case(rom, rom_size, data, data_size,
                     0u, 0u, 25u, UINT32_C(0x00000074), 0u,
                     UINT64_C(144), UINT64_C(4));
            run_case(rom, rom_size, data, data_size,
                     0u, 0u, 25u, UINT32_C(0x00000110), 0u,
                     UINT64_C(161), UINT64_C(4));
            run_case(rom, rom_size, data, data_size,
                     0u, 0u, 25u, UINT32_C(0x000002cf), 0u,
                     UINT64_C(147), UINT64_C(4));
        }
        free(rom);
        free(data);
    }

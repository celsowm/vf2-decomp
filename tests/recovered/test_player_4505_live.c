...
int main(int argc, char **argv)
{
    ...
    } else if (argc == 3 && strcmp(argv[2], "--mask-2059f") == 0) {
        test_quadruple_only = 1;
        test_quadruple_mask = UINT32_C(0x0002059f);
    } else if (argc == 3 && strcmp(argv[2], "--mask-4059f") == 0) {
        test_quadruple_only = 1;
        test_quadruple_mask = UINT32_C(0x0004059f);
    } else if (argc == 3 && strcmp(argv[2], "--mask-c059f") == 0) {
        test_quadruple_only = 1;
        test_quadruple_mask = UINT32_C(0x000c059f);
    } else if (argc == 3 && strcmp(argv[2], "--mask-14059f") == 0) {
        test_quadruple_only = 1;
        test_quadruple_mask = UINT32_C(0x0014059f);
    } else if (argc == 3 && strcmp(argv[2], "--mask-48059f") == 0) {
        test_quadruple_only = 1;
        test_quadruple_mask = UINT32_C(0x0048059f);
    } else if (argc == 3 && strcmp(argv[2], "--mask-50059f") == 0) {
        test_quadruple_only = 1;
        test_quadruple_mask = UINT32_C(0x0050059f);
    } else if (argc == 3 && strcmp(argv[2], "--mask-108059f") == 0) {
        test_quadruple_only = 1;
        test_quadruple_mask = UINT32_C(0x0108059f);
    } else if (argc == 3 && strcmp(argv[2], "--mask-110059f") == 0) {
        test_quadruple_only = 1;
        test_quadruple_mask = UINT32_C(0x0110059f);
    } else if (argc == 3 && strcmp(argv[2], "--mask-6059f") == 0) {
        test_quadruple_only = 1;
        test_quadruple_mask = UINT32_C(0x0006059f);
    } else if (argc == 3 && strcmp(argv[2], "--mask-a059f") == 0) {
        test_quadruple_only = 1;
        test_quadruple_mask = UINT32_C(0x000a059f);
    } else if (argc == 3 && strcmp(argv[2], "--mask-12059f") == 0) {
        test_quadruple_only = 1;
        test_quadruple_mask = UINT32_C(0x0012059f);
    } else if (argc == 3 && strcmp(argv[2], "--mask-42059f") == 0) {
        test_quadruple_only = 1;
        test_quadruple_mask = UINT32_C(0x0042059f);
    } else if (argc == 3 && strcmp(argv[2], "--mask-102059f") == 0) {
        test_quadruple_only = 1;
        test_quadruple_mask = UINT32_C(0x0102059f);
    } else if (argc == 3 && strcmp(argv[2], "--mask-402059f") == 0) {
        test_quadruple_only = 1;
        test_quadruple_mask = UINT32_C(0x0402059f);
    } else if (argc == 3 && strcmp(argv[2], "--mask-410059f") == 0) {
        test_quadruple_only = 1;
        test_quadruple_mask = UINT32_C(0x0410059f);
    } else if (argc == 3 && strcmp(argv[2], "--mask-802059f") == 0) {
        test_quadruple_only = 1;
        test_quadruple_mask = UINT32_C(0x0802059f);
    } else if (argc == 3 && strcmp(argv[2], "--mask-810059f") == 0) {
        test_quadruple_only = 1;
        test_quadruple_mask = UINT32_C(0x0810059f);
    } else if (argc == 3 && strcmp(argv[2], "--mask-1002059f") == 0) {
        test_quadruple_only = 1;
        test_quadruple_mask = UINT32_C(0x1002059f);
    } else if (argc == 3 && strcmp(argv[2], "--mask-1010059f") == 0) {
        test_quadruple_only = 1;
        test_quadruple_mask = UINT32_C(0x1010059f);
    } else if (argc == 3 && strcmp(argv[2], "--mask-8010059f") == 0) {
        test_quadruple_only = 1;
        test_quadruple_mask = UINT32_C(0x8010059f);
    } else if (argc == 3 && strcmp(argv[2], "--mask-0140059f") == 0) {
        test_quadruple_only = 1;
        test_quadruple_mask = UINT32_C(0x0140059f);
    } else if (argc == 3 && strcmp(argv[2], "--mask-0440059f") == 0) {
        test_quadruple_only = 1;
        test_quadruple_mask = UINT32_C(0x0440059f);
    } else if (argc == 3 && strcmp(argv[2], "--mask-1040059f") == 0) {
        test_quadruple_only = 1;
        test_quadruple_mask = UINT32_C(0x1040059f);
    } else if (argc == 3 && strcmp(argv[2], "--mask-0500059f") == 0) {
        test_quadruple_only = 1;
        test_quadruple_mask = UINT32_C(0x0500059f);
    } else if (argc == 3 && strcmp(argv[2], "--mask-0900059f") == 0) {
        test_quadruple_only = 1;
        test_quadruple_mask = UINT32_C(0x0900059f);
    } else if (argc == 3 && strcmp(argv[2], "--mask-0550059f") == 0) {
        test_quadruple_only = 1;
        test_quadruple_mask = UINT32_C(0x0550059f);
    } else if (argc == 3 && strcmp(argv[2], "--mask-4002059f") == 0) {
        test_quadruple_only = 1;
        test_quadruple_mask = UINT32_C(0x4002059f);
    } else if (argc == 3 && strcmp(argv[2], "--mask-8002059f") == 0) {
        test_quadruple_only = 1;
        test_quadruple_mask = UINT32_C(0x8002059f);

...
| Current ROM-proven native boundary | Sixth `fa_player` bootstrap, the accepted `0x14288 -> 0x1428c` / `0x19ef8` corridor, the observed `0x1428c -> 0x142c0` geometry expansion, `0x142c0 -> 0x14310` setup corridor, `0x14310 -> 0x143e4` preamble, state-neutral prefix through `0x143fc`, `0x1ab74 -> 0x1abf4` entry prefix, the `0x27ce0` four-load gate including the equal-selector return to `0x1abf8` and the live branch to `0x27d00`, the immediate `0x27d00 -> 0x28184`, `0x28268 -> 0x28780`, `0x27d90`/`0x27dcc`/`0x27fa0 -> 0x2901c` and `0x28174 -> 0x29414` calls, `0x28184 -> 0x28268` prefix, accepted `0x28780` geometry body and measured `0x14400 -> 0x17710`, `0x14404 -> 0x1791c`, `0x14408 -> 0x4b640`, `0x14414 -> 0x16504` and `0x14418 -> 0x180bc` chain after `fa_game_info` at `0x0001645c` |

...
## Latest measured game-info extension (v0581/v0582/v0583)

The positive state-8 `fa_game_info` compositions `0x0000000e` (bits 1+2+3),
`0x0000001a` (bits 1+3+4) and `0x00000018` (bits 3+4) are now native through
threshold `9`. Each added 12-case matrix covers the three measured
...
`decomp/i960/notes/game_info_18644_positive_mask18_threshold9_v0583.md`.

...
- game_info positive: admit base `0x140` single-middle `19*128=2432` masks `+3/+6` (any one `0x1BFE3EA9` bit except `0x00200000`? Actually include all 20 singles, `0x00200140` also `+3`, net `2432` with `0x00200000` excluded? Wait pure `bit21` was `0/36` before and is `36/36` after via single-middle, so include all 20 → `2560` but `0x140` bare without middle stays `0`, so `19*128=2432` new, total `2007→4439` (v0258, `decomp/i960/notes/game_info_18644_positive_base0140_single_middle_v0258.md`);

# `fa_game_info` positive state-8 mask `0x1e` (v0524)

The measured positive state-8 composition `0x0000001e` (bits 1+2+3+4) is
...
Admission remains limited to the seven measured low masks, the three measured
...
python decomp/i960/tools/validate_game_info_full_dispatch.py \
  build/Debug/vf2i960.exe roms/vf2 --mask 0x1e --thresholds 0,1,2,3,4,5,6,7,8 \

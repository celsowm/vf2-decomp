# `fa_game_info` positive mask `0x114` through threshold 3

The state-8 positive composition `0x00000114` (bits 2+4+8) is admitted through
threshold `3`. Unilateral records use −3 instructions at zero countdown and
+2 otherwise; bilateral records use −2 at zero countdown and +3 otherwise.

...
The admission remains limited to the measured flag distributions, state `8`
on both fighters and thresholds `0..8`. Threshold `9+`, other flag
distributions and unmeasured positive compositions remain

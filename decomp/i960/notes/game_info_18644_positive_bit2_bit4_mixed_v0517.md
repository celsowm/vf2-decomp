...
i960 execution; the combined result is `72/72` exact.
...
Admission is limited to the two masks above, state 8 on both fighters, the
...
The same command with `--mask 0x1a` reproduces the other exact matrix.

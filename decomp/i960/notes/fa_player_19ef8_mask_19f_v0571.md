# `fa_player` `0x19ef8` measured mask `0x19f` (v0571)

The live `0x00510980` / selector `0x505` corridor was replayed from the
`pre14288` park with `fighter+0x1a4` non-branch mask `0x0000019f` (bits 0..4,
7 and 8). All sixteen combinations of branch bits `5,6,21,23` match the

# `fa_game_info` positive mask `0x0c` through threshold 9

## Scope

This note records the measured extension of the state-8 positive composition
`0x0000000c` (bits 2+3) at `0x00018644`. It uses the existing measured
...
The existing correction for mask `0x0c` remains required at zero countdown; no

# `fa_rob` `0x1453c/0x14570`: extended type-5 miss sweep v0553
...
run for every selector `+0x194 == 513..1359` with fighter bases
...
`1..1359`. Selector `1360` reaches an invalid table pointer and remains a
negative control; selectors outside that interval and unmeasured state/scaling
